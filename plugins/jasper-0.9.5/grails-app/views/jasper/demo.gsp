<html>
  <head>
    ...
    <g:jasperIncludes />
%{--    <g:javascript src="jasper.js" />--}%
%{--    <link rel="stylesheet" href="${createLinkTo(dir:'plugins/jasper-0.9/css',file:'jasper.css')}" />--}%
  </head>
  <body>
  ...
  def exampleWithData = {
    ...
    <ul>
        ...
        <ul>
            ...
            <li>Perhaps, split up &lt;g:jasperReport&gt; into difrerent tags, rather than one big tag with so many attributes (DONE! but old method still available)</li>
            <li>Update iText?</li>
        </ul>
