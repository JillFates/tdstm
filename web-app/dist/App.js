...
},{"../modules/header/HeaderModule.js":19,"../modules/licenseAdmin/LicenseAdminModule.js":20,"../modules/licenseManager/LicenseManagerModule.js":28,"../modules/noticeManager/NoticeManagerModule.js":32,"../modules/taskManager/TaskManagerModule.js":36,"../services/RestAPI/RestAPIModule.js":41,"../services/http/HTTPModule.js":44,"angular":"angular","angular-animate":"angular-animate","angular-mocks":"angular-mocks","angular-resource":"angular-resource","angular-sanitize":"angular-sanitize","angular-translate":"angular-translate","angular-translate-loader-partial":"angular-translate-loader-partial","angular-ui-bootstrap":"angular-ui-bootstrap","ngClipboard":7,"rx-angular":"rx-angular","ui-router":"ui-router"}],12:[function(require,module,exports){
/**
...
},{"./list/LicenseManagerList.js":29,"./requestImport/RequestImport.js":30,"./service/LicenseManagerService.js":31,"angular":"angular","ui-router":"ui-router"}],29:[function(require,module,exports){
/**
 * Created by Jorge Morayta on 09/25/2016.
 */
'use strict';
    ...
    _createClass(LicenseManagerList, [{
        ...
        value: function getDataSource() {
            ...
            this.licenseGridOptions = {
                ...
                columns: [{ field: 'licenseId', hidden: true }, { field: 'action', title: 'Action', width: 80, template: '<button class="btn btn-default" ng-click="licenseManagerList.onLicenseDetails(this)"><span class="glyphicon glyphicon-edit"></span></button>' }, { field: 'principal', title: 'Principal' }, { field: 'client', title: 'Client' }, { field: 'project', title: 'Project' }, { field: 'contact_email', title: 'Contact Email' }, { field: 'status', title: 'Status' }, { field: 'type', title: 'Type' }, { field: 'method.name', title: 'Method' }, { field: 'method.id', hidden: true }, { field: 'servers_tokens', title: 'Server/Tokens' }, { field: 'inception', title: 'Inception' }, { field: 'expiration', title: 'Expiration' }, { field: 'environment', title: 'Env.' }],
                dataSource: {
                    pageSize: 10,
                    transport: {
                        read: function read(e) {
                            ...
                            _this.licenseGridOptions.dataSource.data = data;
                            e.success(data);
                            /* });*/
                        }
                    },
                    change: function change(e) {
                        ...
                        if (_this.openLastImportedLicenseId !== 0 && _this.licenseGrid.dataSource._data) {
                            ...
                            if (newLicenseCreated) {
                                _this.onLicenseDetails(newLicenseCreated);
                            }
                        }
                    }
                }
...
},{"../../directives/Svg/svgLoader.js":12,"./edit/TaskManagerEdit.js":37,"./list/TaskManagerController.js":38,"./service/TaskManagerService.js":39,"angular":"angular","ui-router":"ui-router"}],37:[function(require,module,exports){
/**
...
},{"./RestServiceHandler.js":42,"angular":"angular"}],42:[function(require,module,exports){
/**
...
},{"./RequestHandler.js":40}],43:[function(require,module,exports){
'use strict';
...
},{"./HTTPRequestErrorHandlerInterceptor.js":45,"./HTTPRequestHandlerInterceptor.js":46,"./HTTPResponseErrorHandlerInterceptor.js":47,"./HTTPResponseHandlerInterceptor.js":48,"angular":"angular"}],45:[function(require,module,exports){
/**
...
},{"./HTTPInterceptorInterface.js":43}],46:[function(require,module,exports){
/**
 * Created by Jorge Morayta on 12/11/15.
...
},{"./HTTPInterceptorInterface.js":43}],47:[function(require,module,exports){
/**
 * Created by Jorge Morayta on 12/11/15.
...
},{"./HTTPInterceptorInterface.js":43}],48:[function(require,module,exports){
/**
 * Created by Jorge Morayta on 12/11/15.
