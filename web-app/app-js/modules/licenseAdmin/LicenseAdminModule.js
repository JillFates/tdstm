...
// Modal - Controllers
LicenseAdminModule.controller('RequestLicense', ['$log', 'LicenseAdminService', '$uibModalInstance', 'params', RequestLicense]);
LicenseAdminModule.controller('CreatedLicense', ['$log', '$uibModalInstance', 'params', CreatedLicense]);
LicenseAdminModule.controller('ApplyLicenseKey', ['$log', 'LicenseAdminService', '$uibModalInstance', '$rootScope', 'params', ApplyLicenseKey]);
