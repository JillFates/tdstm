...
@Component({
	selector: 'tds-license-view-edit',
	templateUrl: '../tds/web-app/app-js/modules/licenseAdmin/components/view-edit/license-view-edit.component.html',
	styles: [`
...
export class LicenseViewEditComponent implements OnInit {
