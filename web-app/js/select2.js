    ...
    AbstractSelect2 = clazz(Object, {
        ...
        opening: function() {
            ...
            if (mask.length == 0) {
                ...
                var input = this.opts.element
                if(input.attr("onmousedown") !== undefined ){
					var eventName = "onmousedown";
					var valueToReplace = "this.name";
					input.attr(eventName).replace(valueToReplace, input.attr("name"));
