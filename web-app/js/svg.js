var appSVGShapes = (function ($) {
    ...
    public.shape = {
        ...
        serverPhysical: {
            ...
            svg: '<svg xmlns="http://www.w3.org/2000/svg" ><g id="serverPhysicalShapeId" transform="translate(-15, -15) scale(0.26)">	<g id="svg_1">		<polygon id="svg_7" fill="#FFFFFF" stroke="#FFFFFF" points="86,104.1 26.4,104.1 20.8,101.8 5.4,86.4 5.4,8 9.3,4.1 87.7,4.1 			103.2,19.5 105.4,25.1 105.4,84.7 105.4,104.1 		"/>		<polygon id="svg_2" points="10.8,4 88,4.2 103.2,19.6 27.6,19.4 26,19.4 		"/>		<path id="svg_3" d="M105.4,26.3V85c-2.3-1.8-5.1-2.8-8.1-2.8c-3.7,0-7.1,1.6-9.6,4l0,0l0,0c-2.4,2.5-4,5.9-4,9.7			c0,3.1,1,5.9,2.7,8.2H28V26.3L105.4,26.3C105.4,26.3,105.4,26.3,105.4,26.3z M99.1,93.9c-0.5-0.5-1.2-0.8-2-0.8s-1.5,0.3-2,0.8			l0,0c-0.5,0.5-0.8,1.2-0.8,2s0.3,1.5,0.8,2l0,0c0.5,0.5,1.2,0.8,2,0.8s1.5-0.3,2-0.8l0,0c0.5-0.5,0.8-1.2,0.8-2			S99.6,94.3,99.1,93.9L99.1,93.9z"/>		<path id="svg_4" fill="#00FF00" d="M97.1,104.1c4.6,0,8.3-3.7,8.3-8.3c0-4.6-3.7-8.3-8.3-8.3c-4.6,0-8.3,3.7-8.3,8.3			C88.7,100.3,92.5,104.1,97.1,104.1z"/>		<polygon id="svg_5" points="20.8,101.8 5.4,86.7 5.4,9.6 20.8,24.7 20.8,26.4 		"/>	</g></g></svg>'
        },
        serverVirtual: {
