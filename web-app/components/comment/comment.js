 ...
 */
tds.comments.controller.EditCommentDialogController = function ($scope, $modalInstance, $log, $timeout, $q, commentService, alerts, assetTO, defaultCommentType, commentTO, appCommonData, utils, commentUtils) {
