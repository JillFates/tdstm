...
class BulkChangeNumber {
	 ...
	 */
	static void replace(Class type, Number value, String fieldName, List<Long> ids = [], Map idsFilterQuery = null) {
	 ...
	 */
	static Number coerceBulkValue(Project currentProject, Number value) {
		return value
	}
