...
/**
 * The HtmlUtil class contain method to generate HTML from server side e.g. Select Box
 */
class HtmlUtil {
	 ...
	 *   				optionKey as optionKey optionValue as optionValue , default selected value as selection
	 * @param List	    list as from
	 * @return String	HTML selectBox
	 */
	
	def public static genHtmlSelect(def selectId, def selectName, def jsEvent, List from, def optionKey, def optionValue, def selection){
