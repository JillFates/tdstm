...
class AssetCommentCategory {
	...
	static final List<String> list = [GENERAL, DISCOVERY, ANALYSIS, DESIGN, PLANNING, BUILDOUT, WALKTHRU, PREMOVE,
	                                  MOVEDAY, SHUTDOWN, PHYSICAL, TRANSPORT, STARTUP, VERIFY, POSTMOVE,
	                                  CLOSEOUT, LEARNING].asImmutable()

	static final List<String> preMoveCategories = [GENERAL, DISCOVERY, ANALYSIS, DESIGN, PLANNING, BUILDOUT,
	                                               WALKTHRU, PREMOVE, VERIFY, LEARNING].asImmutable()
	...
	static final List<String> planningCategories = [ANALYSIS, DESIGN, PLANNING, BUILDOUT].asImmutable()
}
