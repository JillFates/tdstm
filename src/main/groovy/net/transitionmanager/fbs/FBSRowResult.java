...
public final class FBSRowResult extends Table {
    ...
    public static FBSRowResult getRootAsFBSRowResult(ByteBuffer _bb, FBSRowResult obj) {
    ...
    public FBSRowResult __assign(int _i, ByteBuffer _bb) {
        __init(_i, _bb);
        return this;
    }
    ...
    public ByteBuffer opAsByteBuffer() {
        return __vector_as_bytebuffer(4, 1);
    }

    public ByteBuffer opInByteBuffer(ByteBuffer _bb) {
    ...
    public FBSFieldResult fields(int j) {
        return fields(new FBSFieldResult(), j);
    }

    public FBSFieldResult fields(FBSFieldResult obj, int j) {
        int o = __offset(18);
    ...
    public FBSFieldResult fieldsByKey(String key) {
        int o = __offset(18);
        return o != 0 ? FBSFieldResult.__lookup_by_key(null, __vector(o), key, bb) : null;
    }

    public FBSFieldResult fieldsByKey(FBSFieldResult obj, String key) {
        int o = __offset(18);
        return o != 0 ? FBSFieldResult.__lookup_by_key(obj, __vector(o), key, bb) : null;
    }
    ...
    public FBSTagResults tags() {
        return tags(new FBSTagResults());
    }

    public FBSTagResults tags(FBSTagResults obj) {
        int o = __offset(24);
    ...
    public static void startFBSRowResult(FlatBufferBuilder builder) {
        builder.startObject(11);
    }

    public static void addOp(FlatBufferBuilder builder, int opOffset) {
        builder.addOffset(0, opOffset, 0);
    }

    public static void addRowNum(FlatBufferBuilder builder, int rowNum) {
        builder.addInt(1, rowNum, 0);
    }

    public static void addErrorCount(FlatBufferBuilder builder, int errorCount) {
        builder.addInt(2, errorCount, 0);
    }

    public static void addWarn(FlatBufferBuilder builder, boolean warn) {
        builder.addBoolean(3, warn, false);
    }

    public static void addDuplicate(FlatBufferBuilder builder, boolean duplicate) {
        builder.addBoolean(4, duplicate, false);
    }

    public static void addErrors(FlatBufferBuilder builder, int errorsOffset) {
        builder.addOffset(5, errorsOffset, 0);
    }
    ...
    public static void addIgnore(FlatBufferBuilder builder, boolean ignore) {
        builder.addBoolean(6, ignore, false);
    }

    public static void addFields(FlatBufferBuilder builder, int fieldsOffset) {
        builder.addOffset(7, fieldsOffset, 0);
    }
    ...
    public static void addDomain(FlatBufferBuilder builder, int domainOffset) {
        builder.addOffset(8, domainOffset, 0);
    }

    public static void addComments(FlatBufferBuilder builder, int commentsOffset) {
        builder.addOffset(9, commentsOffset, 0);
    }

    public static int createCommentsVector(FlatBufferBuilder builder, int[] data) {
        builder.startVector(4, data.length, 4);
        for (int i = data.length - 1; i >= 0; i--) builder.addOffset(data[i]);
        return builder.endVector();
    }

    public static void startCommentsVector(FlatBufferBuilder builder, int numElems) {
        builder.startVector(4, numElems, 4);
    }

    public static void addTags(FlatBufferBuilder builder, int tagsOffset) {
        builder.addOffset(10, tagsOffset, 0);
    }
