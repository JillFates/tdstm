...
import { ApiActionViewEditReactionsComponent } from './components/view-edit/api-action-view-edit-reactions.component';
...
@NgModule({
	...
	exports: [],
	entryComponents: [APIActionViewEditComponent],
})
