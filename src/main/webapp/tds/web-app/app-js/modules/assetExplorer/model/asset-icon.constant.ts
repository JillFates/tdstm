...
export const ASSET_ICONS: IconModel = {
	application: {
		...
		icon: '../assets/icons/png/application.png',
		color: '#fff',
		background: '#01ab08'
	},
	// play: '\uf144',
	database: {
		iconAlt: '\uf04c',
		// tslint:disable-next-line:max-line-length
		icon: '../assets/icons/png/database.png',
		color: '#fff',
		background: '#fff200'
	},
	// pause: '\uf28c',
	server: {
		iconAlt: '\uf017',
		// tslint:disable-next-line:max-line-length
		icon: '../assets/icons/png/serverPhysical.png',
		color: '#fff',
		background: '#fff200'
	},
	// clock: '\uf017',
	virtualServer: {
		iconAlt: '\uf068',
		// tslint:disable-next-line:max-line-length
		icon: '../assets/icons/png/serverVirtual.png',
		color: '#fff',
		background: '#9e9e9e'
	},
	logicalStorage: {
