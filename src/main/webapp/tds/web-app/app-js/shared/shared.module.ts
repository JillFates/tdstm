...
import {
	...
	HTTPFactory,
} from './providers/http-request-interceptor.provider.';
import {
	KendoFileUploadInterceptor,
	HTTPKendoFactory,
} from './providers/kendo-file-upload.interceptor';
...
import {
	UIPromptDirective,
	UIPromptService,
} from './directives/ui-prompt.directive';
