...
export const STATE_ICONS_PATH = {
	...
	hold: {
		iconAlt: '\uf04c',
		// tslint:disable-next-line:max-line-length
		icon: 'F M256 8C119 8 8 119 8 256s111 248 248 248 248-111 248-248S393 8 256 8zm-16 328c0 8.8-7.2 16-16 16h-48c-8.8 0-16-7.2-16-16V176c0-8.8 7.2-16 16-16h48c8.8 0 16 7.2 16 16v160zm112 0c0 8.8-7.2 16-16 16h-48c-8.8 0-16-7.2-16-16V176c0-8.8 7.2-16 16-16h48c8.8 0 16 7.2 16 16v160z',
		color: '#fff',
		background: '#fff200'
	},
	// pause: '\uf28c',
...
export const CATEGORY_ICONS_PATH = {
	unknown: {
		iconAlt: '\uf128',
		// tslint:disable-next-line:max-line-length
