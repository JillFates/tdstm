...
import pages.Assets.AssetViews.BulkChangeEditAssetsPage
import pages.Assets.AssetViews.BulkChangeActionPage
...
class AssetsBulkEditSpec extends GebReportingSpec {
    ...
    def "4. Certify confirmation update process"(){
        ...
        then: 'Delete confirmation modal message is correct'
            commonsModule.verifyConfirmationPrompDialogMessage "You are about to update ${assetNames.size()} Assets"
    }
