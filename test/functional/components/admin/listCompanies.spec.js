...
describe('List Companies page', function(){
  ...
  it('should go to List Companies after select Admin - List Companies',function(){
    ...
    expect(menu.getCurrentUrl('/tdstm/partyGroup/list?active=active&tag_s_2_name=asc'))
    .toEqual(process.env.BASE_URL+'/tdstm/partyGroup/list?active=active&tag_s_2_name=asc');
  });
