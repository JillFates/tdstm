...
class BulkAssetChangeServiceIntegrationSpec extends IntegrationSpec {
	...
	void setup() {
		bulkAssetChangeService.dataviewService.projectService.customDomainService = [fieldToBulkChangeMapping: {
			Project p ->
				[
					'tagAssets'  : [
						bulkChangeService: 'tagAssetService',
						bulkChangeActions: [
							add    : 'bulkAdd',
							clear  : 'bulkClear',
							replace: 'bulkReplace',
					...
					retireDate   : [
						bulkChangeService: 'bulkChangeDateService',
						bulkChangeActions: [
							clear  : 'bulkClear',
							replace: 'bulkReplace',
						]
					...
					externalRefId: [
						bulkChangeService: 'bulkChangeStringService',
						bulkChangeActions: [
							clear  : 'bulkClear',
							replace: 'bulkReplace',
						]
					...
					size         : [
						bulkChangeService: 'bulkChangeNumberService',
						bulkChangeActions: [
							clear  : 'bulkClear',
							replace: 'bulkReplace',
						]
					...
					modifiedBy   : [
						bulkChangeService: 'bulkChangePersonService',
						bulkChangeActions: [
							clear  : 'bulkClear',
							replace: 'bulkReplace',
						]
					...
					'moveBundle' : [
						bulkChangeService: 'bulkChangeMoveBundleService',
						bulkChangeActions: [
							replace: 'bulkReplace'
						]
					],
					'custom9'    : [
						bulkChangeService: 'bulkChangeListService',
						bulkChangeActions: [
							clear  : 'bulkClear',
							replace: 'bulkReplace'
						],
		...
		bulkAssetChangeService.bulkChangeMoveBundleService = Mock(BulkChangeMoveBundleService)
		bulkAssetChangeService.bulkChangeListService = Mock(BulkChangeListService)
	...
	void 'Test date/time field bulkChange clear'() {
		...
		then: 'the bulkClear function is invoked, with no tags specified'
			bulkChangeCommand.validate()
			1 * bulkAssetChangeService.bulkChangeDateService.coerceBulkValue(project, editCommand.value)
			1 * bulkAssetChangeService.bulkChangeDateService.bulkClear(null, 'retireDate', [device.id, device2.id], [:])
	}
	...
	void 'Test string field bulkChange clear'() {
		...
		then: 'the bulkClear function is invoked, with no tags specified'
			bulkChangeCommand.validate()
			1 * bulkAssetChangeService.bulkChangeStringService.coerceBulkValue(project, editCommand.value)
			1 * bulkAssetChangeService.bulkChangeStringService.bulkClear(null, 'externalRefId', [device.id, device2.id], [:])
	}
	...
	void 'Test numeric field bulkChange clear'() {
		...
		then: 'the bulkClear function is invoked, with no tags specified'
			bulkChangeCommand.validate()
			1 * bulkAssetChangeService.bulkChangeNumberService.coerceBulkValue(project, editCommand.value)
			1 * bulkAssetChangeService.bulkChangeNumberService.bulkClear(null, 'size', [device.id, device2.id], [:])
	}
	...
	void 'Test person field bulkChange clear'() {
		...
		then: 'the bulkClear function is invoked, with no tags specified'
			bulkChangeCommand.validate()
			1 * bulkAssetChangeService.bulkChangePersonService.coerceBulkValue(project, editCommand.value)
			1 * bulkAssetChangeService.bulkChangePersonService.bulkClear(null, 'modifiedBy', [device.id, device2.id], [:])
	}
	...
	void 'Test bulkChange replace moveBundle'() {
		...
		then: 'the bulkReplace function is invoked'
			bulkChangeCommand.validate()
			1 * bulkAssetChangeService.bulkChangeMoveBundleService.coerceBulkValue(project, editCommand.value)
			1 * bulkAssetChangeService.bulkChangeMoveBundleService.bulkReplace(null, 'moveBundle', [device.id, device2.id], [:])
	}
	...
	void 'Test bulkChange replace list'() {
		...
		then: 'the bulkReplace function is invoked'
			bulkChangeCommand.validate()
			1 * bulkAssetChangeService.bulkChangeListService.coerceBulkValue(project, 'custom9', editCommand.value, ['one potato', 'two potato'])
			1 * bulkAssetChangeService.bulkChangeListService.bulkReplace(null, 'custom9', [device.id, device2.id], [:])
	}
	...
	void 'Test bulkChange clear list'() {
		...
		then: 'the bulkReplace function is invoked'
			bulkChangeCommand.validate()
			1 * bulkAssetChangeService.bulkChangeListService.coerceBulkValue(project, 'custom9', editCommand.value, ['one potato', 'two potato'])
			1 * bulkAssetChangeService.bulkChangeListService.bulkClear(null, 'custom9', [device.id, device2.id], [:])
	}
	...
	void 'Test bulkChange replace inList'() {
		...
		then: 'the bulkReplace function is invoked'
			bulkChangeCommand.validate()
			1 * bulkAssetChangeService.bulkChangeListService.coerceBulkValue(project, 'validation', editCommand.value, ValidationType.list)
			1 * bulkAssetChangeService.bulkChangeListService.bulkReplace(null, 'validation', [device.id, device2.id], [:])
	}
	...
	void 'Test bulkChange clear inList'() {
		...
		then: 'the bulkReplace function is invoked'
			bulkChangeCommand.validate()
			1 * bulkAssetChangeService.bulkChangeListService.coerceBulkValue(project, 'validation', editCommand.value, ValidationType.list)
			1 * bulkAssetChangeService.bulkChangeListService.bulkClear(null, 'validation', [device.id, device2.id], [:])
	}
