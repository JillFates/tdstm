...
class StringUtilTests extends Specification {
	...
	void testDefaultIfEmpty() {
		expect:
		// Has Value
		'abc123' == SU.defaultIfEmpty('abc123', 'foo')
		// Is Blank
		'abc123' == SU.defaultIfEmpty('', 'abc123')
		// Is NULL
		'abc123' == SU.defaultIfEmpty(null, 'abc123')
		// Is Zero(0)
		'0' == SU.defaultIfEmpty('0', 'abc123')
	}

	void testEllipsis() {
		expect:
		// No Ellipsis
		'abcdef' == SU.ellipsis('abcdef', 10)
		// Has Ellipsis
		'abc...' == SU.ellipsis('abcdefgh', 6)
	}

	void testStripOffPrefixChars() {
		expect:
		// Stripped
		'Smith' == SU.stripOffPrefixChars('Mr. ', 'Mr. Smith')
		// Skipped
		'Jones' == SU.stripOffPrefixChars('xyz', 'Jones')
	}
	...
	void testConCat() {
		expect:
		"one" == SU.concat('', 'one')
		"one-NULL" == SU.concat(null, 'one-NULL')
		"one,two" == SU.concat('one', 'two')
		"one : two" == SU.concat('one', 'two', ' : ')
	}
