...
class ETLProcessorSpec extends Specification {
    ...
    def setupSpec () {
        ...
        String.metaClass.mixin StringConcatElement
    }
...
//        secureASTCustomizer.staticStarImportsWhitelist = ['java.lang.Math'] // Only allow the java.lang.Math.* static import
    ...
    void 'test can plus strings and elements in a transformation' () {
    ...
    void 'test can use a stored element in a transformation closure' () {
