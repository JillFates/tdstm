    ...
    object Assets {
        val export = 
            ...
            .exec(http("ImportApplication")
                .get("/tdstm/assetEntity/setImportPerferences?value=true&preference=ImportApplication")
                .headers(headers_31))
                .pause(1)
            .exec(http("ImportServer")
                .get("/tdstm/assetEntity/setImportPerferences?value=true&preference=ImportServer")
                .headers(headers_31))
            .pause(1)
            .exec(http("ImportDatabase")
                .get("/tdstm/assetEntity/setImportPerferences?value=true&preference=ImportDatabase")
                .headers(headers_31))
            .pause(1)
            .exec(http("ImportStorage")
                .get("/tdstm/assetEntity/setImportPerferences?value=true&preference=ImportStorage")
                .headers(headers_31))
            .pause(1)
            .exec(http("ImportRoom")
                .get("/tdstm/assetEntity/setImportPerferences?value=true&preference=ImportRoom")
                .headers(headers_31))
            .pause(1)
                .exec(http("ImportRack")
                .get("/tdstm/assetEntity/setImportPerferences?value=true&preference=ImportRack")
                .headers(headers_31)
    .resources(
        http("ImportDependency")
        .get(uri1 + "/assetEntity/setImportPerferences?value=true&preference=ImportDependency")
        .headers(headers_31)))
    .pause(1)
    .exec(http("ImportCabling")
        .get("/tdstm/assetEntity/setImportPerferences?value=true&preference=ImportCabling")
        .headers(headers_31))
    .pause(1)
    .exec(http("ImportComment")
        .get("/tdstm/assetEntity/setImportPerferences?value=true&preference=ImportComment")
        .headers(headers_31))
    .pause(1)
