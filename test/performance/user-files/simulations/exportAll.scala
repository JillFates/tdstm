    ...
    object Assets {
        val export = 
            ...
            .exec(http("ImportApplication")
                .get("/tdstm/assetEntity/setImportPerferences?selected=true&prefFor=ImportApplication")
                .headers(headers_31))
                .pause(1)
            .exec(http("ImportServer")
                .get("/tdstm/assetEntity/setImportPerferences?selected=true&prefFor=ImportServer")
                .headers(headers_31))
            .pause(1)
            .exec(http("ImportDatabase")
                .get("/tdstm/assetEntity/setImportPerferences?selected=true&prefFor=ImportDatabase")
                .headers(headers_31))
            .pause(1)
            .exec(http("ImportStorage")
                .get("/tdstm/assetEntity/setImportPerferences?selected=true&prefFor=ImportStorage")
                .headers(headers_31))
            .pause(1)
            .exec(http("ImportRoom")
                .get("/tdstm/assetEntity/setImportPerferences?selected=true&prefFor=ImportRoom")
                .headers(headers_31))
            .pause(1)
                .exec(http("ImportRack")
                .get("/tdstm/assetEntity/setImportPerferences?selected=true&prefFor=ImportRack")
                .headers(headers_31)
    .resources(
        http("ImportDependency")
        .get(uri1 + "/assetEntity/setImportPerferences?selected=true&prefFor=ImportDependency")
        .headers(headers_31)))
    .pause(1)
    .exec(http("ImportCabling")
        .get("/tdstm/assetEntity/setImportPerferences?selected=true&prefFor=ImportCabling")
        .headers(headers_31))
    .pause(1)
    .exec(http("ImportComment")
        .get("/tdstm/assetEntity/setImportPerferences?selected=true&prefFor=ImportComment")
        .headers(headers_31))
    .pause(1)
