...
class MoveEventNewsController {
	...
	def list = {
			...
			if(moveEvent){
				...
				def assetCommentsQuery = new StringBuffer( "select ac.asset_comment_id as id, DATE_FORMAT(date_created,'%r') as created, 'I' as type, "+
				...
				def moveEventNewsQuery = new StringBuffer( "select mn.move_event_news_id as id, DATE_FORMAT(date_created,'%r') as created, 'N' as type, "+
