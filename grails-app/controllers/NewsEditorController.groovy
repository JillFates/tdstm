...
class NewsEditorController {
	...
	def newsEditorList = {
		...
		def assetCommentsQuery = new StringBuffer( "select ac.asset_comment_id as id, date_created as createdAt, "+
        ...
        def moveEventNewsQuery = new StringBuffer( "select mn.move_event_news_id as id, date_created as createdAt, "+
