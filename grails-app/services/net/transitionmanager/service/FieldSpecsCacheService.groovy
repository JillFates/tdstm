 ...
 * @see FieldSpecsCacheService#setAllFieldSpecs(net.transitionmanager.domain.Project, java.lang.String, java.util.Map)
...
class FieldSpecsCacheService implements InitializingBean {
    ...
    Map getAllFieldSpecs(Project project, String domain) {
        checkNonNullParams(project, domain)
    ...
    void setAllFieldSpecs(Project project, String domain, Map fieldSpecs) {
        checkNonNullParams(project, domain, fieldSpecs)
    ...
    /**
     * Check if one of the params is a null instance.
     * If any of these params it throws an IllegalArgumentException
     * @param params a list of Object instances.
     */
    private static void checkNonNullParams(Object...params){
