...
//				log.info "createBulkTransition: processing 'done'"
	...
	def getAssetsForListView( def projectId, def bundles, def columns, def params ) {
		...
		def query = new StringBuffer(
			...
			rack_source.location AS sourceLocation, rack_source.tag AS sourceRack, ae.source_rack_position AS sourceRackPosition,
		    rack_target.location AS targetLocation, rack_target.tag AS targetRack, ae.target_rack_position AS targetRackPosition,
