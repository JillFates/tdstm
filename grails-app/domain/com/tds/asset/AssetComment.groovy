...
class AssetComment {
	...
	Boolean autoGenerated = false	// Flag that indicates if a task is auto generated by the system
	Integer recipe					// The receipe id # that caused this task to be created
