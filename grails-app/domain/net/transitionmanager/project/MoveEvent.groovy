...
class MoveEvent {
	...
	public static final List<String> DETAILED_LIST_FIELDS = BASIC_EVENT_FIELDS + ['description', 'dateCreated', 'lastUpdated', 'estStartTime', 'estCompletionTime', 'runbookStatus']
