...
<div tds-autocenter tds-handle-escape (escPressed)="onCancelEdit()"
    ...
    <div class="modal-footer form-group-center">
        ...
        <button class="btn btn-default pull-right component-action-delete" tabindex="502" (click)="onCancelEdit()" type="button"><span  class="glyphicon glyphicon-ban-circle"></span> Cancel</button>
    </div>
</div>