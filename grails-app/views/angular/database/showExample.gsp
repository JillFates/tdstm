			...
			>
				...
				<table>
					<tbody>
						...
						<g:render template="../assetEntity/customShow" model="[assetEntity:asset, 'project':project]"></g:render>
					</tbody>
				</table>
			</div></td>
	</tr>
	<tr id="deps">
		<g:render template="../assetEntity/dependentShow" model="[assetEntity:asset]" ></g:render>
	</tr>
	<tr id="commentListId">
		<g:render template="../assetEntity/commentList" model="['asset':asset, 'prefValue': prefValue, 'viewUnpublishedValue': viewUnpublishedValue]" ></g:render>
	</tr>
	<tr>
		<td colspan="2">
			<div class="buttons">
				<g:form>
					...
					<g:render template="../assetEntity/showButtons" model="[assetEntity:asset]"/>
				</g:form>
			</div>
		</td>
	</tr>
