...
<p>A new account has been created for you but will need to activated ASAP. Please click on the following link or copy it into your browser. You will be presented with a secure web page where you can then set your password. Going forward your username for accessing TransitionManager will be '${username}'.
${activationURL}</p>
