	...
	<g:form name="issueUpdateForm" controller="task" action="update">
		...
		<table style="margin-left: -2px;">
			...
			<tr class="prop">
				...
				<td valign="top" class="value"><g:select id="categoryEditId_${assetComment.id}" name="category" from="${com.tdssrc.grails.GormUtil.getConstrainedProperties(AssetComment).category.inList}" value="${assetComment.category}"></g:select>
