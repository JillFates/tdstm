...
<html>
    <head>
        ...
        <title>Manage Asset Batches</title>
    ...
    <body>
        <tds:subHeader title="Manage Asset Batches" crumbs="['Assets','Manage Asset Batches']"/>
    ...
    <script id="actionButtonsTemplate" type="text/x-kendo-template">
        ...
        <span>|</span>
        # if(importResults){ #
            <a href="\\#" data-link="#:contextPath#/dataTransferBatch/importResults/#:batchId#" title="View Log" class="lnkViewLog"><g:img uri="/icons/script_error.png" width="16" height="16" alt="View Log"/></a> |
        # } else { #
