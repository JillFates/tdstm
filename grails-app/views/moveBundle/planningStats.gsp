...
<body>
	<div class="body">
		<div>
			...
			<div style="margin-top: 40px; margin-left: 5px;width:280px;">
					<h3>
						<b>Discovery</b>
					</h3>
					<table style="border: 0px; margin-left: 10px;">
						<tr>
							...
							<td><g:link controller="application" action="list" params="[validation:'Discovery']">Apps</g:link></td>
						</tr>
						<tr>
			...
			<div>
				...
				<table style="border: 0px; width: 800px;">
					<thead>
						...
						<th style="color: Blue; background-color: white;">Unassigned</th>
			...
			</div>			<div style="clear: both;float: left;margin-top: 40px; margin-left: 100px;">
