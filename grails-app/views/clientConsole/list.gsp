	...
	<thead>
		...
		<tr>
			...
			<th style="padding-top:35px;" >
				...
				<span id="column1Edit"><img src="${resource(dir:'icons',file:'database_edit.png')}" border="0px" onclick="changeLabelToSelect()"/></span>
			...
			<th style="padding-top:35px;">
				...
				<span id="column2Edit"><img src="${resource(dir:'icons',file:'database_edit.png')}" border="0px" onclick="changeLabelToSelect()"/></span>
			...
			<th style="padding-top:35px;">
				...
				<span id="column3Edit"><img src="${resource(dir:'i',file:'database_edit.png')}" border="0px" onclick="changeLabelToSelect()"/></span>
			...
			<th style="padding-top:35px;">
				...
				<span id="column4Edit"><img src="${resource(dir:'icons',file:'database_edit.png')}" border="0px" onclick="changeLabelToSelect()"/></span>
