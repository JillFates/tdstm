...
<div class="wrapper">
    ...
    <footer class="main-footer">
        ...
        <strong><a href="http://www.transitionaldata.com/service/transitionmanager" target="_blank">&nbsp;TransitionManager&trade;</a> 2010-${Calendar.getInstance().get(Calendar.YEAR)} . </strong> </strong><i><strong> Patent Pending</strong></i> All rights reserved.
        <!-- /.container -->
    </footer>
</div>
