    ...
    <div class="main_body">
      ...
      <g:if test="${currProj}">
	      ...
	      <ul>
			...
			<li id="roomMenuId" style="position:relative; float: left;"><a class="home headerClass" onmouseover="hoverMegaMenu('#racksMegaMenu')" href="javascript:showMegaMenu('#racksMegaMenu')">Rooms/Racks</a>
			...
			<li id="eventMenuId" style="position:relative; float: left;"><a class="home headerClass" onmouseover="hoverMegaMenu('#bundleMegaMenu')" href="javascript:showMegaMenu('#bundleMegaMenu')">Events/Bundles </a>
