...
<table>
	<tbody>
		...
		<tr id="bladeHeightId" style="display: ${modelInstance.assetType == 'Blade' ? 'block' : 'none'}">
			<td>Blade Height:</td>
			<td>
				<g:select id="bladeHeightId" name="bladeHeight" from="${modelInstance.constrainedProperties.bladeHeight.inList}" ></g:select>
			</td>
		</tr>
		<tr>
			<!--<td>Use Image:</td>
	...
	<div style="border: 1px solid #5F9FCF;margin-bottom: 10px;margin-right: 5px;">
		<table>
			...
			<tr id="connectorTr${modelConnector.connector}">
					<td><g:select id="typeId${modelConnector.connector}" name="type${modelConnector.connector}" from="${ModelConnector.constrainedProperties.type.inList}" value="${modelConnector.type}"></g:select></td>
			...
			<tr id="connectorTr${count}" style="display: none;">
					<td><g:select id="typeId${count}" name="type" from="${ModelConnector.constrainedProperties.type.inList}"></g:select></td>
