...
<html>
	...
	<body>
		<div class="body fluid">
			...
			<div style="display: none;">
				<table id="assetDependencyRow">
					<tr>
						...
						<td class='combo-td'><span id="Application"><g:select name="asset" id="dependenciesId" from="${applications}" optionKey="${-2}" optionValue="${1}" noSelection="${['null':'Please select']}" style="width:90px;"></g:select></span></td>
			...
			<div style="display: none;">
				<span id="Server"><g:select name="asset" from="${servers}" optionKey="${-2}" optionValue="${1}" noSelection="${['null':'Please select']}" style="width:90px;"></g:select></span>
