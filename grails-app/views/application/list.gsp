			...
			<div style="display: none;">
				<table id="assetDependencyRow">
					<tr>
						...
						<td><span id="Application"><g:select name="asset" from="${applications}" optionKey="${-2}" optionValue="${1}" noSelection="${['null':'Please select']}" style="width:90px;"></g:select></span></td>
