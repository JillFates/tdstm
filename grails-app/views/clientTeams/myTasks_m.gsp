...
<body onorientationchange="updateOrientation();">
	...
	<div class="mainbody" style="width: 220px;" >
		...
		<td><g:link action="myTasks" params='["bundleId":bundleId,"teamId":teamId,"location":location,"projectId":project?.id,"tab":"Todo"]' class="mobmenu mobselect">Tasks</g:link></td>
