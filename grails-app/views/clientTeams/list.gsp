...
<body>
	...
	<span style="font: bold 13px arial; float:left; margin-top: 10px;">Select <g:link controller="clientTeams" action="listComment"  params="[viewMode:'web']" ><span class="buttonR"><input type="button" value="Your Task" class="buttonR"/></span></g:link> or a Team to use:</span>
