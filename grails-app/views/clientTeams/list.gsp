...
<body>
	...
	<span style="font: bold 13px arial; float:left; margin-top: 10px;">Select <g:link controller="clientTeams" action="listComment"  params="[viewMode:'web']" ><span ><input type="button" value="Your Task(${todo})" class="${cssTodo}" /></span></g:link> or a Team to use:</span>
