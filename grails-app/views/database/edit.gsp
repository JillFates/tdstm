					...
					<tbody id="createSupportsList">
						<g:each in="${supportAssets}" var="support" status="i">
							<tr id='row_s_${i}'>
								...
								<td class="dep-${support.status}"><g:select name="asset_support_${i}" from="${servers}" value="${support?.asset?.id}" optionKey="id" optionValue="assetName"></g:select></td>
					...
					<tbody id="createDependentsList">
						<g:each in="${dependentAssets}" var="dependent" status="i">
							<tr id='row_d_${i}'>
								...
								<td class="dep-${dependent.status}"><g:select name="asset_dependent_${i}" from="${servers}" value="${dependent?.dependent?.id}" optionKey="id" optionValue="assetName"></g:select></td>
