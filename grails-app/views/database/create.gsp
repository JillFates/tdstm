						...
						<tr>
							...
							<td>
								<tds:tooltipSpan field="${standardFieldSpecs.validation}" tooltipDataPlacement="bottom">
									<g:select from="${com.tdssrc.grails.GormUtil.getConstrainedProperties(databaseInstance.class).validation.inList}" id="validation" name="validation" value="${ValidationType.UNKNOWN}"/>
								</tds:tooltipSpan>
							</td>
						</tr>
