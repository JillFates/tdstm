...
<body>
	...
	<div class="mainbody" style="width: auto;" >
				...
				<div class="w_techlog">
				<div style="float:left; width:100%;text-align:left; height:20px; border-bottom:1px solid #000000;">
				...
				<g:form action="signIn" name="loginForm">
					...
					<g:if test="${flash.message}">
						<div class="message">${flash.message}</div>
								...
								<div style="float:left; width:100%;"><a href="http://www.transitionaldata.com/" target="new"><img
								src="${createLinkTo(dir:'images',file:'tds.jpg')}" border="0"
								alt="tds" /></a>
								</div>
								<div style="float:left; width:100%;margin:10px 0;"><div style="text-align:center;margin:5px 0; color:#990000;"><b>Transition Manager</b></div>
								<div style="float:left; width:100%;">Username:
