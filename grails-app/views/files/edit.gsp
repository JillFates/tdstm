				...
				<div class="dialog">
					<table>
						<tbody>
							...
							<td><g:select from="${fileInstance.constraints.validation.inList}" id="validation" class="${config.validation}" name="validation" onChange="assetCustoms('edit','Files');assetFieldImportance(this.value,'Files')" value="${fileInstance.validation}"/>	
							</tr>
							<tr>
