						...
						<tbody id="createSupportsList">
							<g:each in="${supportAssets}" var="support" status="i">
								<tr id='row_s_${i}'>
									...
									<td><g:select name="asset_support_${i}" from="${servers}" value="${support?.asset?.id}" optionKey="id" optionValue="assetName"></g:select></td>
					...
					<table style="width: 100%;">
						...
						<g:each in="${dependentAssets}" var="dependent" status="i">
							<tr id='row_d_${i}'>
								...
								<td><g:select name="asset_dependent_${i}" from="${servers}" value="${dependent?.dependent?.id}" optionKey="id" optionValue="assetName"></g:select></td>
