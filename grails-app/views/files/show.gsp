    ...
    <tr>
        <td colspan="2">
            <div class="dialog" <tds:hasPermission
                    permission="${Permission.AssetEdit}">ondblclick="EntityCrud.showAssetEditView('${filesInstance?.assetClass}',${filesInstance?.id})"</tds:hasPermission>>
                <g:if test="${errors}">
                ...
                <table>
                    ...
                    <tr class="prop">
                        ...
                        <td class="valueNW ${standardFieldSpecs.assetName.imp ?: ''}" colspan="3"
                        ...
                        <tds:inputLabel field="${standardFieldSpecs.description}"
                                        value="${filesInstance?.description}"/>
                        <td class="valueNW ${standardFieldSpecs.description.imp ?: ''}" colspan="3"
                    ...
                    <tr class="prop">
                        <tds:showLabelAndField field="${standardFieldSpecs.fileFormat}"
                                               value="${filesInstance.fileFormat}"/>
                        ...
                        <tds:showLabelAndField field="${standardFieldSpecs.supportType}"
                                               value="${filesInstance.supportType}"/>
                        ...
                        <td class="valueNW ${standardFieldSpecs.moveBundle.imp ?: ''}">
                            ...
                            <tds:showDependencyGroup groupId="${dependencyBundleNumber}"
                                                     assetName="${filesInstance.assetName}"/>
                        </td>
                    </tr>
                    <tr class="prop">
                    ...
                    <tr>
                        ...
                        <tds:showLabelAndField field="${standardFieldSpecs.validation}"
                                               value="${filesInstance.validation}" tooltipDataPlacement="bottom"/>
                    </tr>
