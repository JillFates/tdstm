			...
			<table style="width: 400px;">
				...
				<tbody>
					<g:each in="${supportAssets}" var="support" status="i">
						<tr onclick="getFilesDetails('${support?.asset?.assetType}', ${support?.asset?.id})" class="${i%2? 'odd':'even' }" style="cursor: pointer;">
			...
			<table style="width: 400px;">
				...
				<tbody>
					<g:each in="${dependentAssets}" var="dependent" status="i">
						<tr onclick="getFilesDetails('${dependent.dependent?.assetType}', ${dependent.dependent?.id})" class="${i%2? 'odd':'even' }" style="cursor: pointer;">
