<%@page import="net.transitionmanager.project.ProjectTeam" %>
<html>
    <head>
                        ...
                        <tbody>
                        	...
                        	<tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean:projectTeamInstance,field:'role','errors')}">
                                    <g:select id="role" name="role" from="${com.tdssrc.grails.GormUtil.getConstrainedProperties(projectTeamInstance.class).role.inList}" valueMessagePrefix="ProjectTeam.role" value="${projectTeamInstance.role}" ></g:select>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean:projectTeamInstance,field:'isDisbanded','errors')}">
                                    <g:select id="isDisbanded" name="isDisbanded" from="${com.tdssrc.grails.GormUtil.getConstrainedProperties(projectTeamInstance.class).isDisbanded.inList}" value="${projectTeamInstance.isDisbanded}"></g:select>
                                </td>
                            </tr>
                            <tr class="prop">
