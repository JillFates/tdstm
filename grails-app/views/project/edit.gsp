					...
					<tbody>
						...
						<tr class="prop">
							...
							<td class="valueNW ${hasErrors(bean:projectInstance,field:'projectType','errors')}">
								<g:select id="projectType" name="projectType" indextab="130" from="${com.tdssrc.grails.GormUtil.getConstrainedProperties(projectInstance.class).projectType.inList}" value="${projectInstance.projectType}"/>
