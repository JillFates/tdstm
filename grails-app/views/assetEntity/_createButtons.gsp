...
<div class="buttons">
	<button type="button" class="btn btn-default save" data-action='' onclick="EntityCrud.saveToShow($(this),'${assetClass}')"><span class="glyphicon glyphicon-floppy-disk" aria-hidden="true"></span> Save</button>
