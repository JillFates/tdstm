...
<g:else>
 	<g:if test="${ dependency.comment }" >
 		...
 		<a class="" data-toggle="popover" data-content="${dependency.comment}" data-placement="top" onclick="event.stopPropagation(); $('[data-toggle=popover]').popover('toggle');$('[data-toggle=popover]').popover('toggle');"> 
