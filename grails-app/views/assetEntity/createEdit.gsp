		...
		<tr>
			<td colspan="2">
				<div class="buttons">
					 ...
					 <span class="button"><input type="button" class="cancel" value="Cancel" onclick="$('#createEntityView').dialog('close'); $('#showEntityView').dialog('close'); $('#editEntityView').dialog('close'); $('#select2-drop-mask').click();"/> </span>
				</div>
			</td>
		</tr>
	</table>
