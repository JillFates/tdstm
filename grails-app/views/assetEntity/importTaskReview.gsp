...
<div class="body account-import-review">
	<h1>Import Tasks - Step 2 &gt; Review Tasks</h1>
	...
	<script>
		...
		$(document).ready(function() {
			...
			$("#grid").kendoGrid({
				...
				dataSource: {
					type: "json",
					transport: {
						read: "${createLink(action:'importTaskReviewData', params:paramsForReviewDataRequest)}"
					},
					error: processErrors,
					schema: {
						model: {
		...
		<div>
			<g:form action="importTask" class="form-inline" name="postForm">
