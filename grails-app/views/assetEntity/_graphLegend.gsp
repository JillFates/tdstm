	...
	<table id="legendId" cellpadding="0" cellspacing="0" style="margin-left: 5px;border: 0;" >
		...
		<g:each in="${assetTypes}" var="entry" status="i">
			...
			<tr>
				<td style="padding:0px; text-align: center;">
					<svg id="${names.internalName}ShapeLeftPanel" style="width: 35px; height: 35px; border-width: 0px;"><use xlink:href="${'#' + names.internalName + 'ShapeId'}" class="node" x="18" y="15" style="fill: #1f77b4;"></use></svg>
				</td>
		...
		<tr id="colorKeyTemplateId" class="hidden">
			<td class="bundleColorExample">
				<svg style="width: 35px;height: 35px;border-width: 0px;"><use xlink:href="#applicationShapeId" class="node" x="18" y="15" style="fill: #1f77b4;"></use></svg>
			</td>
