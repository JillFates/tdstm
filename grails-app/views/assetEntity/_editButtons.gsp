...
<g:if test="${redirectTo!='dependencyConsole'}">
	 <span class="button"><input type="button" class="save updateDep" data-redirect='${redirectTo}' data-action='' value="Update" onclick="AssetCrudModule.performAssetUpdate($(this),'${whom}'); " /> </span>
...
<g:else>
	 <span class="button"><input type="button" class="save updateDep" data-action='' value="Update" onclick="AssetCrudModule.performAssetUpdate($(this),'${whom}')" /> </span>
