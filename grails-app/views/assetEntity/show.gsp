    ...
    <table style="border:0;width:1000px;" class="assetEntity" data-id="${assetEntity?.id}">
        <tr>
            <td colspan="2">
                <div class="dialog"
                     <tds:hasPermission
                             permission="${Permission.AssetEdit}">ondblclick="EntityCrud.showAssetEditView('${assetEntity.assetClass}', ${assetEntity?.id})"</tds:hasPermission>>
                    <g:if test="${errors}">
                    ...
                    <table>
                        ...
                        <tr class="prop">
                            <tds:showLabelAndField field="${standardFieldSpecs.assetType}"
                                                   value="${assetEntity.assetType}"/>

                            <tds:showLabelAndField field="${standardFieldSpecs.environment}"
                                                   value="${assetEntity.environment}"/>
                        ...
                        <tr class="prop">
                            <tds:inputLabel field="${standardFieldSpecs.manufacturer}"
                                            value="${assetEntity.manufacturer}"/>
                            <td class="valueNW ${standardFieldSpecs.manufacturer.imp ?: ''}">
                                <tds:tooltipSpan field="${standardFieldSpecs.manufacturer}">
                                    <a href='javascript:showManufacturer(${assetEntity.manufacturer?.id})'
                                       style='color:#00E'>${assetEntity.manufacturer}</a>
                                </tds:tooltipSpan>
                            </td>

                            <tds:showLabelAndField field="${standardFieldSpecs.priority}"
                                                   value="${assetEntity.priority}"/>

                            <td class="label ${standardFieldSpecs.locationSource.imp ?: ''}" nowrap="nowrap">
                                <label for="locationSource" data-toggle="popover" data-trigger="hover"
                                       data-content="Location">Location</label>
                            </td>
                        ...
                        <tr class="prop">
                            ...
                            <td class="valueNW ${standardFieldSpecs.model.imp ?: ''}">
                                <tds:tooltipSpan field="${standardFieldSpecs.model}">
                                    <a href='javascript:showModel(${assetEntity.model?.id})'
                                       style='color:#00E'>${assetEntity.model}</a>
                                    <g:if test="${!assetEntity.model?.isValid()}"><span style="color: red;"><b>?</b>
                                    </span></g:if>
                                </tds:tooltipSpan>
                            </td>

                            <tds:showLabelAndField field="${standardFieldSpecs.ipAddress}"
                                                   value="${assetEntity.ipAddress}"/>

                            <td class="label nonVMLabel ${standardFieldSpecs.roomSource.imp ?: ''}" nowrap="nowrap">
                                <label for="roomSource" data-toggle="popover" data-trigger="hover"
                                       data-content="Room">Room</label>
                            </td>
                        ...
                        <tr class="prop">
                            <tds:showLabelAndField field="${standardFieldSpecs.shortName}"
                                                   value="${assetEntity.shortName}"/>
                            ...
                            <%-- rackable --%>
                            <td class="label rackLabel ${standardFieldSpecs.rackSource.imp ?: ''}" nowrap="nowrap"
                                id="rackId">
                                <label for="rackSourceId" data-toggle="popover" data-trigger="hover"
                                       data-content="Rack/Cab">Rack/Cab</label>
                            </td>
                            ...
                            <%-- blade --%>
                            <td class="label bladeLabel ${standardFieldSpecs.sourceChassis.imp ?: ''}" nowrap="nowrap"
                                id="bladeId" style="display: none">
                        ...
                        <tr class="prop">
                            <tds:showLabelAndField field="${standardFieldSpecs.serialNumber}"
                                                   value="${assetEntity.serialNumber}"/>

                            <tds:showLabelAndField field="${standardFieldSpecs.supportType}"
                                                   value="${assetEntity.supportType}"/>

                            <td class="label positionLabel ${standardFieldSpecs.sourceRackPosition.imp ?: ''}"
                                nowrap="nowrap">
                                <label for="rackSource" data-toggle="popover" data-trigger="hover"
                            ...
                            <td class="rackLabel valueNW ${standardFieldSpecs.sourceRackPosition.imp ?: ''}">
                                <tds:tooltipSpan tooltipDataPlacement="bottom"
                                                 field="${standardFieldSpecs.sourceRackPosition}">
                                    ${assetEntity.sourceRackPosition}
                                </tds:tooltipSpan>
                            </td>
                            <td class="rackLabel valueNW ${standardFieldSpecs.targetRackPosition.imp ?: ''}">
                                <tds:tooltipSpan tooltipDataplacement="bottom"
                                                 field="${standardFieldSpecs.targetRackPosition}">
                            ...
                            <td class="bladeLabel ${standardFieldSpecs.sourceBladePosition.imp ?: ''}"
                                style="    display: none">
                                <tds:tooltipSpan tooltipDataPlacement="bottom"
                                                 field="${standardFieldSpecs.sourceBladePosition}">
                                    ${assetEntity.sourceBladePosition}
                                </tds:tooltipSpan>
                            </td>
                            <td class="bladeLabel ${standardFieldSpecs.targetBladePosition.imp ?: ''}"
                                style="display: none">
                                <tds:tooltipSpan tooltipDataPlacement="bottom"
                                                 field="${standardFieldSpecs.targetBladePosition}">
                        ...
                        <tr class="prop">
                            <tds:showLabelAndField field="${standardFieldSpecs.assetTag}"
                                                   value="${assetEntity.assetTag}"/>
                        ...
                        <tr class="prop">
                            <tds:showLabelAndField field="${standardFieldSpecs.railType}"
                                                   value="${assetEntity.railType}"/>
                            ...
                            <tds:showLabelAndField field="${standardFieldSpecs.planStatus}"
                                                   value="${assetEntity.planStatus}"/>

                            <tds:showLabelAndField field="${standardFieldSpecs.rateOfChange}"
                                                   value="${assetEntity.rateOfChange}"/>

                        </tr>
                        <tr>
                            <tds:showLabelAndField field="${standardFieldSpecs.externalRefId}"
                                                   value="${assetEntity.externalRefId}"/>

                            <g:if test="! assetEntity.isVM()">
                                <td class="label ${standardFieldSpecs.truck.imp ?: ''}" nowrap="nowrap">
                                    <label for="truck" data-toggle="popover" data-trigger="hover"
                                           data-content="${standardFieldSpecs.truck.tip ?: standardFieldSpecs.truck.label}">
                                        Truck/Cart/Shelf
                                    </label>
                                </td>
                            ...
                            <tds:showLabelAndField field="${standardFieldSpecs.validation}"
                                                   value="${assetEntity.validation}"/>
                            <td>&nbsp;</td>
                        </tr>
