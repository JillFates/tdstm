		...
		<table style="width: 100%;">
			...
			<g:each in="${supportAssets}" var="support" status="i">
				...
				<tr id='row_s_${i}_${support.id}'>
					<td><g:select name="dataFlowFreq_support_${support.id}" value="${support.dataFlowFreq}" from="${com.tdssrc.grails.GormUtil.getConstrainedProperties(support.class).dataFlowFreq.inList}" /></td>
				...
				<tr id='row_d_${i}_${dependent.id}'>
					...
					<td>
						<g:select name="dataFlowFreq_dependent_${dependent.id}" 
							value="${dependent.dataFlowFreq}" from="${com.tdssrc.grails.GormUtil.getConstrainedProperties(dependent.class).dataFlowFreq.inList}"
						></g:select>
					</td>
