...
<div id="controlPanel" style="float: left;border: 1px solid #ccc;margin-left: 3px;margin-top: 3px;width: 150px; background-color:white;position: absolute;display: ${(showControls=='controls')?('block'):('none')};">
	<table id="labelTree" cellpadding="0" cellspacing="0" style="margin-left: 5px;border: 0;width: 148px;" >
		...
		<tr title="Sets the desired length for the links">
			...
			<td style="padding-left :5px">
				...
				<input type="text" id="linkSizeId" name="linkSize" value="${defaults.linkSize}" disabled="disabled" style="width: 40px;border: 0px;background-color: #FFF;text-align: center;" >
		...
		<tr title="Sets the height of the SVG in pixels">
			...
			<td style="padding-left :5px">
				...
				<input type="text" id="heightId" name="height" value="${defaults.height}" disabled="disabled" style="width: 40px;border: 0px;background-color: #FFF;text-align: center;" >
		...
		<tr title="Sets the width of the SVG in pixels">
			...
			<td style="padding-left :5px">
				...
				<input type="text" id="widthId" name="width" value="${defaults.width}" disabled="disabled" style="width: 40px;border: 0px;background-color: #FFF;text-align: center;" >
		...
		<tr>
			...
			<td colspan="2" style="padding: 0px;">
				<input type="checkbox" name="labels" id="Server" ${(labelMap.Server=='true') ? 'checked' : ''} value="servers" class="pointer" onchange="rebuildMap()"/>
		...
		<tr>
			...
			<td colspan="2" style="padding: 0px;">
				<input type="checkbox" name="labels" id="Database" ${(labelMap.Database=='true') ? 'checked' : ''} value="databases" class="pointer" onchange="rebuildMap()"/>
		...
		<tr>
			...
			<td colspan="2" style="padding: 0px;">
				<input type="checkbox" name="labels" id="Files" ${(labelMap.Files=='true') ? 'checked' : ''} value="files" class="pointer" onchange="rebuildMap()"/>
		...
		<tr>
			...
			<td colspan="2" style="padding: 0px;">
				<input type="checkbox" name="labels" id="Network" ${(labelMap.Network=='true') ? 'checked' : ''} value="networks" class="pointer" onchange="rebuildMap()"/>
